...
const cacheName = '_75ProjectTeama8-2021-11-02 13:12:13.580177'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeama8'.length) === '_75ProjectTeama8') {
